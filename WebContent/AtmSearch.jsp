...
<%!int j;%>
<%
	MainSearchCls atmobj = new MainSearchCls();
	Vector atmvec = atmobj.retATMs();
%>
<%
					...
					<form id="search-form" action="searchresult.jsp" method="post">
						<fieldset>
							<input type="text" name="search" id="search"
								value="ATMs"
								onFocus="if(this.value =='ATMs' ) this.value=''" />
							<a href="#">Search</a>
							...
							<div class="wrapper">
								<div class="color">
									<table>
										...
										<tr>
											<td>Phone</td>
											<td><%=atmvec.get(j + 1)%></td>
										</tr>
										<tr>
											<td>Email:</td>
											<td><%=atmvec.get(j + 2)%></td>
										</tr>
										<tr>
											<td>Address:</td>
											<td><%=atmvec.get(j + 3)%></td>
										</tr>
