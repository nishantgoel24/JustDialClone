...
<%!int j;%>
<%
	MainSearchCls resobj = new MainSearchCls();
	Vector resvec = resobj.retRestaurants();
%>
<%
							...
							<div class="wrapper">
								<div class="color">
									<table>
										...
										<tr>
											<td>Phone</td>
											<td><%=resvec.get(j + 1)%></td>
										</tr>
										<tr>
											<td>Email:</td>
											<td><%=resvec.get(j + 2)%></td>
										</tr>
										<tr>
											<td>Address:</td>
											<td><%=resvec.get(j + 3)%></td>
										</tr>
